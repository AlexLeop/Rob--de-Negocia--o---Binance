...
class Config:
    ...
    TRADE_AMOUNT_USD = float(os.getenv("TRADE_AMOUNT_USD", 6.0)) # Exposição por perna
    ...
    TARGET_PNL = float(os.getenv("TARGET_PNL_USD", 0.25))
    STOP_LOSS = float(os.getenv("STOP_LOSS_USD", 1.50))
